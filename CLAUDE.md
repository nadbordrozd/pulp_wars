...
Use Beads (`bd`) for all durable task tracking. Run `bd prime` at the beginning
of a session or whenever context may be stale. Do not use markdown TODO lists or
ad hoc memory files; use Beads issues and `bd remember`.
