...
try {
  ...
  await evaluate(
    connection,
    `(() => {
      localStorage.removeItem('pulpWars.save.v7r7.current');
  ...
  const preview = await evaluate<PreviewEvidenceV7>(
    ...
    `(() => {
      ...
      const save = JSON.parse(localStorage.getItem('pulpWars.save.v7r7.current') ?? 'null');
  ...
  const keys = await evaluate<{
    ...
    connection,
    `({ current: localStorage.getItem('pulpWars.save.v7r7.current'), oldV7: localStorage.getItem('pulpWars.save.v7.current'), oldV7r2: localStorage.getItem('pulpWars.save.v7r2.current'), oldV7r3: localStorage.getItem('pulpWars.save.v7r3.current'), oldV7r4: localStorage.getItem('pulpWars.save.v7r4.current'), oldV7r5: localStorage.getItem('pulpWars.save.v7r5.current'), oldV7r6: localStorage.getItem('pulpWars.save.v7r6.current'), v6: localStorage.getItem('pulpWars.save.current'), settings: localStorage.getItem('pulpWars.settings.v1'), unrelated: localStorage.getItem('pulpWars.unrelated') })`,
  );
  if (
    keys.current !== null ||
    keys.oldV7 !== null ||
